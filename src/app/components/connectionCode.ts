...
export class ConnectionCode extends Code {
  ...
  sourceVariable(): string {
    return this.connection.source.code.nodeVariable();
  }

  targetVariable(): string {
    return this.connection.target.code.nodeVariable();
  }
  ...
  connect(): string {
    ...
    let script: string = '';
    script += 'nest.Connect(' + this.sourceVariable() + ', ' + this.targetVariable();
